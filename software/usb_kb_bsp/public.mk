...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80011d8
SOPC_SYSID_FLAG += --sidp=0x80011d8
ELF_PATCH_FLAG  += --sidp 0x80011d8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1636729795
SOPC_SYSID_FLAG += --timestamp=1636729795
ELF_PATCH_FLAG  += --timestamp 1636729795
